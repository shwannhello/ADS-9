...
private:
    ...
    void collectPermsSequential(std::shared_ptr<Node> node, std::vector<char>& current,
                               std::vector<std::vector<char>>& result, int& counter, int target,
                               std::vector<char>& targetPerm, bool& found);
